...
import com.zbook.manage.config.DataSourceProperties;

@Configuration
@EnableTransactionManagement
@EnableConfigurationProperties(DataSourceProperties.class)
@MapperScan("com.zbook.manage.mapper")
public class DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() throws Exception { //NOSONAR
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.zbook.manage.domain");
